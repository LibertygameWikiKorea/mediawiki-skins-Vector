...
const templateData = {
	...
	'data-user-links-preferences': {
		...
		class: '',
		'html-items': '<li id="ca-uls" class="vector-menu-item--collapsible mw-list-item active"><a href="#" class="uls-trigger cdx-button cdx-button--weight-quiet"><span class="vector-icon mw-ui-icon-wikimedia-language"></span> <span>English</span></a></li>'
	},
	'data-user-links-user-page': {
		id: 'p-personal-user-page',
		class: '',
		'html-items': '<li id="pt-userpage-2" class="vector-menu-item--collapsible mw-list-item"><a href="/wiki/User:Admin" class="cdx-button cdx-button--weight-quiet" title="Your user page [⌃⌥.]" accesskey="."><span>Admin</span></a></li>'
	},
	...
	'data-user-links-menus': [ {
		...
		id: 'p-personal',
		'html-items': `
			<li id="pt-userpage" class="vector-menu-item--collapsible mw-list-item"><a href="/wiki/User:Admin" title="Your user page [.]" accesskey="."><span class="vector-icon mw-ui-icon-userAvatar mw-ui-icon-wikimedia-userAvatar"></span> <span>Admin</span></a></li>
			...
			<li id="pt-watchlist" class="vector-menu-item--collapsible mw-list-item"><a href="/wiki/Special:Watchlist" title="A list of pages you are monitoring for changes [l]" accesskey="l"><span class="vector-icon mw-ui-icon-watchlist mw-ui-icon-wikimedia-watchlist"></span> <span>Watchlist</span></a></li>
